...
Процедура ЕдиницаИзмеренияНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	//++бит Интеграция с QMS 
	//Проверка движений товара в QMS. Если движений нет, то можно менять.
	Если бит_ИнтеграцияQMSВызовСервера.ПроверитьДвиженияНоменклатурыВQMS(Объект.Ссылка) = Ложь Тогда
		Сообщение = Новый СообщениеПользователю;
		Сообщение.Текст = "Невозможно изменить упаковку. В системе QMS есть движения по данной номенклатурной позиции.";
