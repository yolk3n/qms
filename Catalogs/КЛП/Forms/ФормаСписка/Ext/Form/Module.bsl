...
Процедура КомандаОткрытьНоменклатуру(Команда)
	...
	ИначеЕсли ЕстьПравоСозданияНоменклатуры И Не ЗначениеЗаполнено(ДанныеСтроки.КодЕСКЛП) Тогда
		
		// Ручное создание номенклатуры доступно только для АТ, которые не были загружены из сервиса.
...
Процедура СоздатьНоменклатуру(Команда)
	...
	Для Каждого ВыделеннаяСтрока Из Элементы.Список.ВыделенныеСтроки Цикл
		Если ТипЗнч(ВыделеннаяСтрока) <> Тип("СтрокаГруппировкиДинамическогоСписка") Тогда
			...
			Если ЗначениеЗаполнено(ДанныеСтроки.Номенклатура) Или ЗначениеЗаполнено(ДанныеСтроки.КодЕСКЛП) Тогда
				// Ручное создание номенклатуры доступно только для АТ, которые не были загружены из сервиса.
				Продолжить;
			КонецЕсли;
