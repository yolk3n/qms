...
Процедура ПриИзмененииНоменклатурыСопоставления_НоменклатураКонтрагентов(Форма, ДанныеСопоставления) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриИзмененииНоменклатурыСопоставления_НоменклатураКонтрагентов(Форма, ДанныеСопоставления);
...
Процедура ОбработкаПолученияДанныхВыбора_НоменклатураКонтрагентов(ДанныеВыбора, Параметры, СтандартнаяОбработка) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ОбработкаПолученияДанныхВыбора_НоменклатураКонтрагентов(ДанныеВыбора, Параметры, СтандартнаяОбработка);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииСвойствУпаковкиЕдиницыИзмеренияНоменклатуры(Знач Упаковка, Знач Номенклатура, СвойстваУпаковки) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриОпределенииСвойствУпаковкиЕдиницыИзмеренияНоменклатуры(Упаковка, Номенклатура, СвойстваУпаковки);
	// Конец БольничнаяАптека
...
Процедура НайтиНаименованиеЕдиницыИзмеренияПоКодуОКЕИ(КодОКЕИЕдиницыИзмерения, НаименованиеЕдиницыИзмерения) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.НайтиНаименованиеЕдиницыИзмеренияПоКодуОКЕИ(КодОКЕИЕдиницыИзмерения, НаименованиеЕдиницыИзмерения);
	// Конец БольничнаяАптека
...
Процедура ВладелецУпаковкиЕдиницыИзмеренияНоменклатура(Знач Упаковка, ВладелецУпаковкиНоменклатура) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ВладелецУпаковкиЕдиницыИзмеренияНоменклатура(Упаковка, ВладелецУпаковкиНоменклатура);
	// Конец БольничнаяАптека
...
Процедура БазоваяЕдиницаИзмеренияНоменклатуры(Знач Номенклатура, ЕдиницаИзмерения) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.БазоваяЕдиницаИзмеренияНоменклатуры(Номенклатура, ЕдиницаИзмерения);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииВладельцаНоменклатурыКонтрагента(Знач Контрагент, Владелец) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриОпределенииВладельцаНоменклатурыКонтрагента(Контрагент, Владелец);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииСвойствНоменклатурыИнформационнойБазы(Знач НаборНоменклатуры, СвойстваНоменклатурИБ) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриОпределенииСвойствНоменклатурыИнформационнойБазы(НаборНоменклатуры, СвойстваНоменклатурИБ);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииПредставленийСопоставленияНоменклатуры(Представления) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриОпределенииПредставленийСопоставленияНоменклатуры(Представления);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииСтруктурыНоменклатурыИнформационнойБазы(СтруктураНоменклатуры) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриОпределенииСтруктурыНоменклатурыИнформационнойБазы(СтруктураНоменклатуры);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииШтрихкодовНоменклатурыКонтрагента(Знач НоменклатураИБ, Штрихкод, ДругиеШтрихкодыНоменклатуры) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПриОпределенииШтрихкодовНоменклатурыКонтрагента(НоменклатураИБ, Штрихкод, ДругиеШтрихкодыНоменклатуры);
	// Конец БольничнаяАптека
...
Процедура ПроверитьИспользованиеХарактеристик(ХарактеристикиИспользуются) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ПроверитьИспользованиеХарактеристик(ХарактеристикиИспользуются);
	// Конец БольничнаяАптека
...
Процедура ЗначениеНаименованияДанныхСопоставленияНоменклатурыБЭД(Знач СсылкаНаОбъект, ЗначениеНаименования) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ЗначениеНаименованияДанныхСопоставленияНоменклатурыБЭД(СсылкаНаОбъект, ЗначениеНаименования);
	// Конец БольничнаяАптека
...
Процедура ЗначенияНаименованийДанныхСопоставленияНоменклатурыБЭД(Знач НаборСсылокНаОбъекты, СоответствиеЗначенийНаименований) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ЗначенияНаименованийДанныхСопоставленияНоменклатурыБЭД(НаборСсылокНаОбъекты, СоответствиеЗначенийНаименований);
	// Конец БольничнаяАптека
...
Процедура ОпределитьНаименованиеТипаОбъектаСопоставленияНоменклатурыБЭД(Знач СсылкаНаОбъект, НаименованиеТипаОбъекта) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ОпределитьНаименованиеТипаОбъектаСопоставленияНоменклатурыБЭД(СсылкаНаОбъект, НаименованиеТипаОбъекта);
	// Конец БольничнаяАптека
...
Процедура ТекстЗапросаПоискаВариантовСопоставленияПоШтрихкодамКомбинаций(ТекстЗапроса) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ТекстЗапросаПоискаВариантовСопоставленияПоШтрихкодамКомбинаций(ТекстЗапроса);
	// Конец БольничнаяАптека
...
Процедура ИнициализацияТекстаЗапросаПоискаСопоставленияПоНатуральнымКлючам(ТекстЗапроса) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ИнициализацияТекстаЗапросаПоискаСопоставленияПоНатуральнымКлючам(ТекстЗапроса);
	// Конец БольничнаяАптека
...
Процедура ТекстЗапросаПоискаВариантовСопоставленияУпаковкиНоменклатурыБЭД(ТекстЗапроса) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптека.ТекстЗапросаПоискаВариантовСопоставленияУпаковкиНоменклатурыБЭД(ТекстЗапроса);
	// Конец БольничнаяАптека
