...
Процедура ОпределитьРазделыСВариантамиОтчетов(Разделы) Экспорт
	...
	// БольничнаяАптека
	ВариантыОтчетовБольничнаяАптека.ОпределитьРазделыСВариантамиОтчетов(Разделы);
...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	// БольничнаяАптека
	ВариантыОтчетовБольничнаяАптека.НастроитьВариантыОтчетов(Настройки);
	// Конец БольничнаяАптека
...
Процедура ЗарегистрироватьИзмененияКлючейВариантовОтчетов(Изменения) Экспорт
	...
	// БольничнаяАптека
	ВариантыОтчетовБольничнаяАптека.ЗарегистрироватьИзмененияКлючейВариантовОтчетов(Изменения);
	// Конец БольничнаяАптека
...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	// БольничнаяАптека
	ВариантыОтчетовБольничнаяАптека.ОпределитьОбъектыСКомандамиОтчетов(Объекты);
	// Конец БольничнаяАптека
