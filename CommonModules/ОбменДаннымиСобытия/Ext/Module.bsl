...
Функция ЗначенияСвойствДляСсылки(Ссылка, СвойстваОбъекта, Знач СвойстваОбъектаСтрокой, Знач ОбъектМетаданныхИмя)
	...
	Если Выборка.Следующий() Тогда
		...
		Для Каждого Элемент Из ЗначенияСвойств Цикл
			...
			// БольничнаяАптека
			Если Элемент.Ключ = "ИдентификаторОбъектаМетаданных" Тогда
				ЗначенияСвойств[Элемент.Ключ] = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Ссылка.Метаданные());
				Продолжить;
			КонецЕсли;
...
Функция ЗначениеСвойстваОбъекта(Объект, СтрокаСвойствОбъекта)
	...
	Для Каждого ИмяСвойства Из МассивПодстрок Цикл
		...
		// БольничнаяАптека
		Если ИмяСвойства = "ИдентификаторОбъектаМетаданных" Тогда
			Значение = ОбщегоНазначения.ИдентификаторОбъектаМетаданных(Значение.Метаданные());
			Продолжить;
		КонецЕсли;
		// Конец БольничнаяАптека
