...
Процедура ПриОпределенииОбъектовСЗаблокированнымиРеквизитами(Объекты) Экспорт
	...
	// БольничнаяАптека
	Объекты.Вставить(Метаданные.Справочники.БанковскиеСчетаКонтрагентов.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.БанковскиеСчетаОрганизаций.ПолноеИмя(), "");
	...
	Объекты.Вставить(Метаданные.Справочники.МедицинскиеКарты.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.Номенклатура.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ОтделенияОрганизаций.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.РегистрЛекарственныхСредств.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.КЛП.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.СМНН.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.СерииНоменклатуры.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.Склады.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ТорговыеНаименования.ПолноеИмя(), "");
	Объекты.Вставить(Метаданные.Справочники.ФормыВыпуска.ПолноеИмя(), "");
	//++бит_ИнтеграцияQMS блокировка реквизитов, если документ отправлен в QMS
	Объекты.Вставить(Метаданные.Документы.ОтпускТоваровВОтделение.ПолноеИмя(), "");
	//--бит
