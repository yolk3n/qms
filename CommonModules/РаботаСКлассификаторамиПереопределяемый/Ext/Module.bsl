...
Процедура ПриДобавленииКлассификаторов(Классификаторы) Экспорт
	...
	// ЭлектронноеВзаимодействие.КТРУ
	КлассификаторКТРУ.ПриДобавленииКлассификаторов(Классификаторы);
	// Конец ЭлектронноеВзаимодействие.КТРУ
	
	// БольничнаяАптека
	КлассификацияМИПоВидам.ПриДобавленииКлассификаторов(Классификаторы);
	Справочники.КлассификаторОКПД2.ПриДобавленииКлассификаторов(Классификаторы);
...
Процедура ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры) Экспорт
	...
	// ЭлектронноеВзаимодействие.КТРУ
	КлассификаторКТРУ.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры);
	// Конец ЭлектронноеВзаимодействие.КТРУ
	
	// БольничнаяАптека
	КлассификацияМИПоВидам.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан, ДополнительныеПараметры);
	Справочники.КлассификаторОКПД2.ПриЗагрузкеКлассификатора(Идентификатор, Версия, Адрес, Обработан);
	// Конец БольничнаяАптека
