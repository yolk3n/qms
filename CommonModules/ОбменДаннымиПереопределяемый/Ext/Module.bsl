...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// БольничнаяАптека
	ОбменДаннымиБольничнаяАптека.ПолучитьПланыОбмена(ПланыОбменаПодсистемы);
	// Конец БольничнаяАптека
...
Процедура РегистрацияИзмененийНачальнойВыгрузкиДанных(Знач Получатель, СтандартнаяОбработка, Отбор) Экспорт
	...
	// БольничнаяАптека
	ОбменДаннымиБольничнаяАптека.РегистрацияИзмененияДляНачальнойВыгрузки(Получатель, СтандартнаяОбработка, Отбор);
	// Конец БольничнаяАптека
...
Процедура ПриНастройкеПодчиненногоУзлаРИБ() Экспорт
	...
	// БольничнаяАптека
	ОбменДаннымиСобытияБольничнаяАптека.ПриНастройкеПодчиненногоУзлаРИБ();
	// Конец БольничнаяАптека
...
Процедура ПриПолученииДоступныхВерсийФормата(ВерсииФормата) Экспорт
	...
	// БольничнаяАптека
	ОбменДаннымиБольничнаяАптека.ПриПолученииДоступныхВерсийФормата(ВерсииФормата);
	// Конец БольничнаяАптека
