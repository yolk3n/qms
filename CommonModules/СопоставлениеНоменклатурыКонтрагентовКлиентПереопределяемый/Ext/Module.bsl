...
Процедура Подключаемый_ВыполнитьКомандуИнтеграции_НоменклатурыКонтрагентов(Форма, Команда, Источник) Экспорт	
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптекаКлиент.Подключаемый_ВыполнитьКомандуИнтеграции_НоменклатурыКонтрагентов(Форма, Команда, Источник);
...
Процедура ПриСозданииНоменклатурыПоДаннымКонтрагента(Знач НаборНоменклатурыКонтрагентов, Знач ОповещениеОЗавершении, 
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптекаКлиент.ПриСозданииНоменклатурыПоДаннымКонтрагента(НаборНоменклатурыКонтрагентов, ОповещениеОЗавершении, Контекст, СтандартнаяОбработка);
	// Конец БольничнаяАптека
...
Процедура ОткрытьФормуНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность, Знач ОповещениеОЗакрытии) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптекаКлиент.ОткрытьФормуНоменклатуры(Параметры, Владелец, Уникальность, ОповещениеОЗакрытии);
	// Конец БольничнаяАптека
...
Процедура ОткрытьФормуВыбораНоменклатуры(Знач Параметры, Знач Владелец, Знач Уникальность) Экспорт
	...
	// БольничнаяАптека
	СопоставлениеНоменклатурыКонтрагентовБольничнаяАптекаКлиент.ОткрытьФормуВыбораНоменклатуры(Параметры, Владелец, Уникальность);
	// Конец БольничнаяАптека
