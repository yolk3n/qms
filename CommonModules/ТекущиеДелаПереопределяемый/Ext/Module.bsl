...
Процедура ПриОпределенииОбработчиковТекущихДел(ТекущиеДела) Экспорт
	...
	// БольничнаяАптека
	ТекущиеДелаБольничнаяАптека.ПриОпределенииОбработчиковТекущихДел(ТекущиеДела);
...
Процедура ПриОпределенииПорядкаРазделовКомандногоИнтерфейса(Разделы) Экспорт
	...
	// БольничнаяАптека
	ТекущиеДелаБольничнаяАптека.ПриОпределенииПорядкаРазделовКомандногоИнтерфейса(Разделы);
	// Конец БольничнаяАптека
...
Процедура УстановитьОбщиеПараметрыЗапросов(Запрос, ОбщиеПараметрыЗапросов) Экспорт
	...
	// БольничнаяАптека
	ТекущиеДелаБольничнаяАптека.УстановитьОбщиеПараметрыЗапросов(Запрос, ОбщиеПараметрыЗапросов);
	// Конец БольничнаяАптека
