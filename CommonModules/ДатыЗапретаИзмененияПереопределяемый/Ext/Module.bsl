...
Процедура НастройкаИнтерфейса(НастройкиРаботыИнтерфейса) Экспорт
	...
	// БольничнаяАптека
	ДатыЗапретаИзмененияБольничнаяАптека.НастройкаИнтерфейса(НастройкиРаботыИнтерфейса);
...
Процедура ПриЗаполненииРазделовДатЗапретаИзменения(Разделы) Экспорт
	...
	// БольничнаяАптека
	ДатыЗапретаИзмененияБольничнаяАптека.ПриЗаполненииРазделовДатЗапретаИзменения(Разделы);
	// Конец БольничнаяАптека
...
Процедура ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных) Экспорт
	...
	// БольничнаяАптека
	ДатыЗапретаИзмененияБольничнаяАптека.ЗаполнитьИсточникиДанныхДляПроверкиЗапретаИзменения(ИсточникиДанных);
	// Конец БольничнаяАптека
...
Процедура ПередПроверкойЗапретаИзменения(Объект,
	...
	// БольничнаяАптека
	ДатыЗапретаИзмененияБольничнаяАптека.ПередПроверкойЗапретаИзменения(Объект, ПроверкаЗапретаИзменения, УзелПроверкиЗапретаЗагрузки, ВерсияОбъекта);
	// Конец БольничнаяАптека
