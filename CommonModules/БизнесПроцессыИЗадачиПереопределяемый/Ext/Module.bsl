...
Процедура ПриЗаписиСпискаБизнесПроцессов(Запись) Экспорт
	...
	// БольничнаяАптека
	БизнесПроцессыИЗадачиБольничнаяАптека.ПриЗаписиСпискаБизнесПроцессов(Запись);
...
Процедура ПриОпределенииБизнесПроцессов(ПодключенныеБизнесПроцессы) Экспорт
	...
	// БольничнаяАптека
	БизнесПроцессыИЗадачиБольничнаяАптека.ПриОпределенииБизнесПроцессов(ПодключенныеБизнесПроцессы);
	// Конец БольничнаяАптека
