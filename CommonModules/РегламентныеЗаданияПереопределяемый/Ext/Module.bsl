...
Процедура ПриОпределенииНастроекРегламентныхЗаданий(Настройки) Экспорт
	...
	МенеджерОборудования.ПриОпределенииНастроекРегламентныхЗаданий(Настройки, Метаданные.ФункциональныеОпции.ИспользоватьПодключаемоеОборудование);
	// БольничнаяАптека
	// Регламентные задания, которые не нужно включать при включении ФО,
	// т.к. настройка использования рег. задания выполняется пользователем на панели админимтрирования БПО.
	РегламентныеЗаданияНеВключать = Новый Массив;
	РегламентныеЗаданияНеВключать.Добавить(Метаданные.РегламентныеЗадания.ОчисткаИсторииПлатежныхОпераций);
	РегламентныеЗаданияНеВключать.Добавить(Метаданные.РегламентныеЗадания.ОчисткаИсторииФискальныхОпераций);
	РегламентныеЗаданияНеВключать.Добавить(Метаданные.РегламентныеЗадания.ОчисткаИсторииОперацийОчередиЧеков);
	Для Каждого РегламентноеЗадание Из РегламентныеЗаданияНеВключать Цикл
		Настройка = Настройки.Найти(РегламентноеЗадание, "РегламентноеЗадание");
	...
	// БольничнаяАптека
	РегламентныеЗаданияБольничнаяАптека.ПриОпределенииНастроекРегламентныхЗаданий(Настройки);
	// Конец БольничнаяАптека
