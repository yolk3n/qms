...
Процедура ПриПолученииСпискаШаблонов(ШаблоныЗаданий) Экспорт
	...
	// ИнтеграцияМДЛП
	ИнтеграцияМДЛП.ПриПолученииСпискаШаблонов(ШаблоныЗаданий);
	// Конец ИнтеграцияМДЛП
	
	// ИнтеграцияРЭМД
	ШаблоныЗаданий.Добавить(Метаданные.РегламентныеЗадания.ПроверкаАктуальностиСправочниковФНСИ.Имя);
	ШаблоныЗаданий.Добавить(Метаданные.РегламентныеЗадания.ФедеральныеВебСервисыРЭМДОтправкаЗаявокНаРегистрацию.Имя);
	ШаблоныЗаданий.Добавить(Метаданные.РегламентныеЗадания.ФедеральныеВебСервисыУдалениеСтарыхДокументовИзАрхиваЭМД.Имя);
	ШаблоныЗаданий.Добавить(Метаданные.РегламентныеЗадания.ФедеральныеВебСервисыРЭМДАвтоматическоеПодписаниеСертификатомМедОрганизации.Имя);
	// Конец ИнтеграцияРЭМД
	
	// БольничнаяАптека
	ОчередьЗаданийБольничнаяАптека.ПриПолученииСпискаШаблонов(ШаблоныЗаданий);
...
Процедура ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам) Экспорт
	...
	// ИнтеграцияМДЛП
	ИнтеграцияМДЛП.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	// Конец ИнтеграцияМДЛП
	
	// БольничнаяАптека
	ОчередьЗаданийБольничнаяАптека.ПриОпределенииПсевдонимовОбработчиков(СоответствиеИменПсевдонимам);
	// Конец БольничнаяАптека
