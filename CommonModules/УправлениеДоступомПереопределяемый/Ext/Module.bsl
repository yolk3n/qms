...
Процедура ПриЗаполненииВидовДоступа(ВидыДоступа) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриЗаполненииВидовДоступа(ВидыДоступа);
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриЗаполненииСписковСОграничениемДоступа(Списки);
	// Конец БольничнаяАптека
...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
	// Конец БольничнаяАптека
...
Процедура ПриЗаполненииЗависимостейПравДоступа(ЗависимостиПрав) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриЗаполненииЗависимостейПравДоступа(ЗависимостиПрав);
	// Конец БольничнаяАптека
...
Процедура ПриОпределенииИнтерфейсаНастройкиДоступа(УпрощенныйИнтерфейс) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриОпределенииИнтерфейсаНастройкиДоступа(УпрощенныйИнтерфейс);
	// Конец БольничнаяАптека
...
Процедура ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриЗаполненииИспользованияВидаДоступа(ВидДоступа, Использование);
	// Конец БольничнаяАптека
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	// БольничнаяАптека
	Если СтрНайти(Описание, "Справочник.МашиночитаемыеДоверенностиОрганизаций.Чтение.Организации") = 0 Тогда
		Описание = Описание + "
		|Справочник.МашиночитаемыеДоверенностиОрганизаций.Чтение.Организации
		|";
	КонецЕсли;
	Если СтрНайти(Описание, "Справочник.МашиночитаемыеДоверенностиОрганизаций.Изменение.Организации") = 0 Тогда
		Описание = Описание + "
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание);
	// Конец БольничнаяАптека
...
Процедура ПриИзмененииНаборовЗначенийДоступа(Ссылка, СсылкиНаЗависимыеОбъекты) Экспорт
	...
	// БольничнаяАптека
	УправлениеДоступомБольничнаяАптека.ПриИзмененииНаборовЗначенийДоступа(Ссылка, СсылкиНаЗависимыеОбъекты);
	// Конец БольничнаяАптека
