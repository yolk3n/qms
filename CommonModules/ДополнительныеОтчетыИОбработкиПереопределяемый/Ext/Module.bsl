...
Процедура ОпределитьРазделыСДополнительнымиОбработками(Разделы) Экспорт
	...
	// БольничнаяАптека
	ДополнительныеОтчетыИОбработкиБольничнаяАптека.ОпределитьРазделыСДополнительнымиОбработками(Разделы);
...
Процедура ОпределитьРазделыСДополнительнымиОтчетами(Разделы) Экспорт
	...
	// БольничнаяАптека
	ДополнительныеОтчетыИОбработкиБольничнаяАптека.ОпределитьРазделыСДополнительнымиОтчетами(Разделы);
	// Конец БольничнаяАптека
