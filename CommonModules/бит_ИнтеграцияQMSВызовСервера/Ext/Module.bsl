...
Процедура ВыгрузкаИзQMSРасходныхДокументов() Экспорт
	...
	ИначеЕсли СтатусОтвета = "1" Тогда
		//успешно
		ТаблицаВыгрузки = НоваяТаблицаВыгрузки();
...
Функция ПодготовитьМассивДанныхДокумента(НомерДокумента,ДатаДокумента,ИмяДокумента)
	...
	ТаблицаЗначений = НоваяТаблицаХэширования();
...
Процедура СоздатьОбновитьДокумент(Шапка, ТаблицаНоменклатуры)
	...
	//вычисление хэша
	ТаблицаДляХэша = НоваяТаблицаХэширования();
...
Функция НоваяТаблицаВыгрузки() Экспорт
...
Функция НоваяТаблицаХэширования() Экспорт
...
Функция НовыеДанныеFinance() Экспорт
