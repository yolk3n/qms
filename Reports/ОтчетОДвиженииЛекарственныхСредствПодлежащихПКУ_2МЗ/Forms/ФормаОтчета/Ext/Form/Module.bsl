...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьВидимостьПодразделений(ЭтотОбъект);
...
Процедура РазделУчетаПриИзменении(Элемент)
	...
	УстановитьСостояниеОтображенияНеактуальность(Элементы.Результат, ИдентификаторЗадания);
	ОтчетыБольничнаяАптекаКлиентСервер.ПриИзмененииРеквизитаОтчета(ЭтотОбъект, "РазделУчета");
	УстановитьВидимостьПодразделений(ЭтотОбъект);
...
Процедура ОтборыПриИзменении(Элемент)
	...
	Реквизиты.Добавить("РазделУчета");
...
&НаКлиенте
Процедура ПоказыватьВсеГруппыПКУПриИзменении(Элемент)
...
Процедура УстановитьВидимостьПодразделений(Форма)
	
	Форма.Элементы.Отделение.Видимость = (Форма.Отчет.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаСебестоимостиТоваров.ТоварыВОтделениях"));
	Форма.Элементы.Подразделение.Видимость = (Форма.Отчет.РазделУчета = ПредопределенноеЗначение("Перечисление.РазделыУчетаСебестоимостиТоваров.ТоварыНаСкладах"));
...
Процедура УстановитьСтандартныеНастройкиНаСервере()
	...
	Отчет.ПоказыватьВсеГруппыПКУ = Ложь;
...
Процедура ЗаполнитьПредопределенныеГруппировки()
	...
	ГруппировкаОтчета.Поле = "ГруппаПКУ";
	ГруппировкаОтчета.Представление = НСтр("ru = 'Группа ПКУ'");
	ГруппировкаОтчета.ТипГруппировки = Перечисления.ТипыГруппировокОтчетов.БезГрупп;
