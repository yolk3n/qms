...
Функция ДобавитьКомандуОтчета(КомандыОтчетов) Экспорт
	...
	Если ПравоДоступа("Просмотр", Метаданные.Отчеты.КонтрольОстаточныхСроковГодностиПриПоступлении) Тогда
		
		КомандаОтчет = КомандыОтчетов.Добавить();
		
		КомандаОтчет.Менеджер      = Метаданные.Отчеты.КонтрольОстаточныхСроковГодностиПриПоступлении.ПолноеИмя();
		КомандаОтчет.Представление = НСтр("ru = 'Контроль остаточного срока годности'");
		КомандаОтчет.Важность      = МенюОтчетыБольничнаяАптека.ПодменюОтчетыВажное();
		КомандаОтчет.КлючВарианта  = "КонтрольОстаточногоСрокаГодности";
