...
&НаКлиенте
Процедура ВРазрезеНДСПриИзменении(Элемент)
...
&НаКлиенте
Процедура ПоказыватьВсеГруппыБухгалтерскогоУчетаПриИзменении(Элемент)
...
Процедура УстановитьСтандартныеНастройкиНаСервере()
	...
	Отчет.ВРазрезеНДС = Ложь;
	Отчет.ПоказыватьВсеГруппыБухгалтерскогоУчета = Ложь;
...
Функция ПолучитьИсключаемыеПоля(Режим = "")
	...
	СписокПолей.Добавить("ОтметкаБухгалтерии");
