...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
    ...
    Если Объект.Бит_ОтправленВQMS Тогда
...
Процедура Подключаемый_РазрешитьРедактированиеРеквизитовОбъекта(Команда)
	Если Бит_ИнтеграцияQMSВызовСервера.ПроверитьДвиженияДокументаВQMS(Объект.Ссылка) Тогда
		Если Бит_ИнтеграцияQMSВызовСервера.УдалитьДокументВQMS(Объект.Ссылка) Тогда
    		ЗапретРедактированияРеквизитовОбъектовКлиент.РазрешитьРедактированиеРеквизитовОбъекта(ЭтотОбъект);
		Иначе
			Сообщить("Невозможно отредактировать документ, так как в системе QMS есть движения по нему.");
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры
//--бит
