...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если (ИмяСобытия = "ИзменениеСостоянияМДЛП"
	  ...
	  Или ИмяСобытия = "Запись_УведомлениеОПовторномВводеВОборотМДЛП")
...
Процедура УстановитьДоступностьЭлементовПоТипуСклада()
	...
	ОбщегоНазначенияБольничнаяАптекаКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ТоварыЗаполнитьИсточникФинансирования", "Доступность", ТипСклада = Перечисления.ТипыСкладов.РозничныйМагазин);
...
Процедура СформироватьТекстУведомленияМДЛП()
	...
	СовместноВводимыеУведомления.Вставить(Метаданные.Документы.УведомлениеОВыбытииМДЛП, "1");
	СовместноВводимыеУведомления.Вставить(Метаданные.Документы.УведомлениеОПовторномВводеВОборотМДЛП, "1");
