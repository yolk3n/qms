...
Функция ДоступныеПечатныеФормы() Экспорт
	...
	Обработки.ПечатьНакладнаяНаОтпускМатериалов0510458.ДобавитьПечатнуюФорму(ПечатныеФормы);
	...
	ПечатнаяФорма.ДополнительныеПараметры.ВыводитьРаздел1 = Истина;
...
Функция ТекстЗапросаДанныеДляПечати()
	...
	|	Документ.ДоговорКонтрагента.НомерДоговора                  КАК ДоговорНомер,
	|	Документ.ДоговорКонтрагента.ДатаДоговора                   КАК ДоговорДата,
