...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДоступныеСклады = Справочники.Склады.ПолучитьДоступные(Перечисления.ТипыСкладов.ТипыСкладовОтделений());
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(Список, "СкладПолучатель", ОтборСкладПолучатель,,, ЗначениеЗаполнено(ОтборСкладПолучатель));
...
#КонецОбласти // СтандартныеПодсистем
