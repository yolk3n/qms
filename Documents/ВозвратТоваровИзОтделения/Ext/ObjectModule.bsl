...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ОбщегоНазначенияБольничнаяАптека.ИзменитьПризнакСогласованностиДокумента(
		ЭтотОбъект,
		РежимЗаписи,
		Перечисления.СтатусыПеремещенийТоваров.КОтгрузке);
...
Процедура ИнициализироватьДокумент()
	...
	Если Не ПолучитьФункциональнуюОпцию("ИспользоватьСтатусыВозвратовТоваровИзОтделения") Тогда
...
Процедура ЗаполнитьПоляПоУмолчанию()
	...
	СкладПолучатель = ЗначениеНастроекБольничнаяАптекаПовтИсп.ПолучитьСкладАптекиПоУмолчанию(СкладПолучатель, ПодразделениеОрганизации);
...
Процедура ЗаполнитьДокументПоОтпускуВОтделение(ДокументОснование, ЗаполнятьШапкуДокумента = Истина) Экспорт
	...
	|	Документ.СкладОтправитель          КАК СкладПолучатель,
