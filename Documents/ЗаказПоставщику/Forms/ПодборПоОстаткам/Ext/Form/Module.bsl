...
&НаКлиенте
Процедура ВыбратьТоварыВыполнить(Команда)
...
&НаКлиенте
Процедура ИсключитьТоварыВыполнить(Команда)
...
&НаСервере
Процедура ЗаполнитьТаблицуТоваров(Документ, Заказ)
	...
	Выборка = Документы.ЗаказПоставщику.ПолучитьРезультатЗапросаПоОстаткам(Заказ, Документ).Выбрать();
	...
	Для Каждого ТекущаяСтрока Из Товары Цикл
		...
		ТекущаяСтрока.СтрокаВыбрана = Не ТекущаяСтрока.ПрисутствуетВДокументе;
