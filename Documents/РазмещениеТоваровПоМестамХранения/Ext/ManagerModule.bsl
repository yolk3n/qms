...
Функция ТекстЗапросаВтТаблицаТовары()
	...
	|ИЗ
	|	Документ.РазмещениеТоваровПоМестамХранения.Товары КАК ТаблицаТовары
	|ГДЕ
...
Функция ДоступныеПечатныеФормы() Экспорт
	...
	МенеджерПечати = "Документ.РазмещениеТоваровПоМестамХранения";
...
Функция ПолучитьТекстЗапросаДанныеДляПечати()
	...
	|	)
	|ИЗ
	|	Документ.РазмещениеТоваровПоМестамХранения КАК Документ,
...
Функция ПолучитьТекстЗапросаПечатиЭтикетокИЦенников()
	...
	|ИЗ
	|	Документ.РазмещениеТоваровПоМестамХранения.Товары КАК ТаблицаТоваров
	|ГДЕ
