...
Функция ДобавитьПечатнуюФорму(ПечатныеФормы) Экспорт
	...
	ПечатнаяФорма = УправлениеПечатьюБольничнаяАптека.ДобавитьПечатнуюФорму(ПечатныеФормы, "ИнвентаризационнаяОписьНФА_0504087_194н", МенеджерПечати);
...
// Функция формирует печатную форму требование накладная ф.0504087, ред. 194н
//
Функция ПечатьИнвентаризационнаяОписьНФА_0504087_194н(МассивОбъектов, ОбъектыПечати, ПараметрыПечати) Экспорт
...
Процедура СформироватьТабличныйДокумент(ТабличныйДокумент, Макет, ДанныеДляПечати, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		Пока ВыборкаСтрокТовары.Следующий() Цикл
			...
			КоличествоНеСоответствующееУсловиямАктива = 0;
			СуммаНеСоответствующаяУсловиямАктива      = 0;
			...
			Если Не БезФактическихДанных Тогда
				...
				КоличествоНеСоответствующееУсловиямАктива = ВыборкаСтрокТовары.КоличествоНеСоответствующееУсловиямАктива;
				СуммаНеСоответствующаяУсловиямАктива      = ?(БухКоличество <> 0, КоличествоНеСоответствующееУсловиямАктива * БухСумма / БухКоличество, 0);
			...
			ДанныеСтроки.Вставить("КоличествоНеСоответствующееУсловиямАктива", КоличествоНеСоответствующееУсловиямАктива);
			ДанныеСтроки.Вставить("СуммаНеСоответствующаяУсловиямАктива"     , СуммаНеСоответствующаяУсловиямАктива);
		...
		// Вывод области ПричинаРасхождений
		ФормированиеПечатныхФормБольничнаяАптека.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "ПричинаРасхождений");
		
		// Вывод области МатериальноОтветственноеЛицо
		ФормированиеПечатныхФормБольничнаяАптека.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "МатериальноОтветственноеЛицо", ДанныеШапки);
		...
		// Вывод области ЗаключениеКомиссии
		ФормированиеПечатныхФормБольничнаяАптека.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "ЗаключениеКомиссии");
...
Функция ИнициализироватьСтруктуруИтогов()
	...
	ПараметрыИтого.Вставить("НеСоответствуетУсловиямАктиваКоличество", 0);
	ПараметрыИтого.Вставить("НеСоответствуетУсловиямАктиваСумма"     , 0);
...
Функция МетаданныеМакета()
	...
	Возврат Метаданные.Обработки.ПечатьИнвентаризационнаяОписьНФА_0504087_194н.Макеты.ПФ_MXL_ИнвентаризационнаяОписьНФА_0504087_194н;
