...
Функция ДобавитьПечатнуюФорму(ПечатныеФормы) Экспорт
	...
	ПечатнаяФорма = УправлениеПечатьюБольничнаяАптека.ДобавитьПечатнуюФорму(ПечатныеФормы, "НакладнаяНаОтпускМатериалов0510458", МенеджерПечати);
...
//
Функция ПечатьНакладнаяНаОтпускМатериалов0510458(МассивОбъектов, ОбъектыПечати) Экспорт
...
Функция МетаданныеМакета()
	...
	Возврат Метаданные.Обработки.ПечатьНакладнаяНаОтпускМатериалов0510458.Макеты.ПФ_MXL_НакладнаяНаОтпускМатериалов0510458;
