...
Функция ДобавитьПечатнуюФорму(ПечатныеФормы) Экспорт
	...
	ПечатнаяФорма = УправлениеПечатьюБольничнаяАптека.ДобавитьПечатнуюФорму(ПечатныеФормы, "НакладнаяНаВнутреннееПеремещение0504102", МенеджерПечати);
...
Процедура СформироватьТабличныйДокумент(ТабличныйДокумент, Макет, ДанныеДляПечати, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		ФормированиеПечатныхФормБольничнаяАптека.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "ОтметкаБухгалтерииШапка");
		
		// Вывод области ОтметкаБухгалтерииСтрока
		ФормированиеПечатныхФормБольничнаяАптека.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "ОтметкаБухгалтерииСтрока", ПараметрыИтого);
		
		// Вывод области Исполнитель
		ФормированиеПечатныхФормБольничнаяАптека.ВывестиОбластьПоИмени(ТабличныйДокумент, Макет, "Исполнитель", ДанныеШапки);
