...
Функция ДобавитьПечатнуюФорму(ПечатныеФормы) Экспорт
	...
	ПечатнаяФорма = УправлениеПечатьюБольничнаяАптека.ДобавитьПечатнуюФорму(ПечатныеФормы, "ТребованиеНакладная0510451", МенеджерПечати);
...
// Функция формирует печатную форму требование накладная ф.0510451
//
Функция ПечатьТребованиеНакладная0510451(МассивОбъектов, ОбъектыПечати, ПараметрыПечати) Экспорт
...
Функция МетаданныеМакета()
	...
	Возврат Метаданные.Обработки.ПечатьТребованиеНакладная0510451.Макеты.ПФ_MXL_ТребованиеНакладная0510451;
